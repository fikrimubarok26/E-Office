...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="list_akses" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
...
<div class="modal fade" tabindex="-1" role="dialog" id="modalTambah">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formAddAkses">
                <div class="modal-body">
                    <div class="form-group">
                        <label>Kode Akses</label>
                        <input type="text" name="kode_akses" id="kode_akses" class="form-control" required>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form id="formEditAkses">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Kode Akses</label>
                        <input type="text" name="kode_akses" id="kode_akses1" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Nama Akses</label>
                        <input type="text" name="akses" id="akses1" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
