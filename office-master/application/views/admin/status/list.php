...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="list_status" class="table table-striped table-bordered" style="width:100%">
                <thead>
                    <tr>
            ...
            <form id="formAddStatus">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_status" id="kode_status" class="form-control" required>
                    </div>
        ...
        <div class="modal-content">
            ...
            <form id="formEditStatus">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Kode Status</label>
                        <input type="text" name="kode_status" id="kode_status1" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Status Surat</label>
                        <input type="text" name="status" id="status1" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label>Keterangan</label>
