        ...
        <tr>
            ...
            <td style="width:50%;padding:5px;text-align:justify;">
                <table style="width:100%;border-collapse: collapse;font-size:16px;border-spacing: 0;float:right;">
                    ...
                    <tr>
                        <td style="padding:5px;vertical-align:center;" colspan="2">Perihal : <?= $surat->perihal ?>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:5px;vertical-align:center;" colspan="2">Jenis Surat : <?= $surat->jenis ?>
                        </td>
                    </tr>
        </tr>
        <tr>
            <td style="padding:5px;vertical-align:center;" colspan="2">Lampiran : - </td>
        </tr>
        <tr>
            <?php if ($surat->tanggal_konfirmasi == 0000 - 00 - 00) { ?>

            <td style="padding:5px;vertical-align:center;" colspan="2">Tanggal Dikonfirmasi : Belum Di Konfirmasi</td>

            <?php } else { ?>

            <td style="padding:5px;vertical-align:center;" colspan="2">Tanggal Dikonfirmasi :
                <?= date("d-m-Y", strtotime($surat->tanggal_konfirmasi)) ?></td>
                ...
                <table style="width:100%;border-collapse: collapse;font-size:16px;border-spacing: 0;float:right;">
                    <tr>
                        ...
                        <td style="padding:5px;vertical-align:center;text-align:center;" colspan="2">
                            ...
                            <img width="100px"
                                src="https://chart.googleapis.com/chart?chs=270x270&cht=qr&chld=M|1&choe=UTF-8&chl=192.168.2.30/office/admin/track/<?= $NoSuratnya ?>">
