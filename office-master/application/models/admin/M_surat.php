...
class M_surat extends CI_Model
{
    ...
    private function _get_datatables_query()
    {
        ...
        $this->db->join('t_aksi', 't_aksi.id = t_disposisi.aksi', 'left');
        

        // $this->db->where('t_disposisi.status', '0');
    ...
    function data_disposisi($id)
    {
        ...
        // SELECT * FROM t_surat 
        // LEFT JOIN t_jabatan ON t_jabatan.id 
        // LIKE '%t_surat.aksi_kirim%' 
        // LEFT JOIN t_disposisi ON t_disposisi.id_surat = ". $this->req->encKey('t_surat.id') . " 
        // WHERE ". $this->req->encKey('t_surat.id') . " = '" . $id . "'")->row();
    }
