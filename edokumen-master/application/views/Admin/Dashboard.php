                ...
                <div class="card-body">
                    ...
                    <div class="input-group">
                        <div class="custom-file">
                            <input type="file" name="logo" onchange="loadFile(event)" class="custom-file-input"
                                id="logo" onchange="">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Yayasan"
                            required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>No Telp</label>
                        <input type="number" name="no_telp_1" id="no_telp_1" class="form-control"
                            placeholder="No Telp 1" required>
                    </div>
