            ...
            <section class="section">
                <div class="container-fluid mt-5">
                    <div class="row">
                        ...
                        <div class="col-md-5 pl-5 d-none d-lg-block d-xl-block">
                            <div class="section-body changelog">
                                <?php foreach ($changelog as $key) { ?>
                                <h2 class="section-title"> <?= $key['version'] ?></h2>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="activities">

                                            <?php foreach ($key['detail'] as $key_) { ?>
                                            <div class="activity">
                                                <?php if ($key_->action == 1) { ?>
                                                <div class="activity-icon bg-success text-white shadow-primary">
                                                    <i class="fas fa-plus"></i>
                                                </div>
                                                <?php } ?>
                                                <?php if ($key_->action == 2) { ?>
                                                <div class="activity-icon bg-info text-white shadow-primary">
                                                    <i class="fas fa-cog"></i>
                                                </div>
                                                <?php } ?>
                                                <?php if ($key_->action == 3) { ?>
                                                ...
                                                <div class="activity-detail">
                                                    <div class="mb-2">
                                                        <span
                                                            class="text-job text-primary"><?= date_format(date_create($key_->tgl), "Y-m-d"); ?></span>
                                                        <span class="bullet"></span>
                                                        <a class="text-job" href="#"><?= $key_->job ?></a>
                                                    </div>
                                                    <p><?= $key_->detail ?></p>
                                                </div>
                                            </div>
